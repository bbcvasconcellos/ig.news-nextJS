...
export const getStaticPaths = () => {
  return {
    paths: [], //vazio = gerado estaticamente de acordo com o acesso das pessoas. preenchido com slugs = carrega as paginas estaticamente
    fallback: 'blocking'
  }
}
...
export const getStaticProps: GetStaticProps = async({ params }) => {
  ...
  return {
    ...
    redirect: 60 * 30, //atualiza a cada 30 min
  }
